            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('register') }}" class="row text-start">
                    ...
                    <div class="form-group col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-person-badge me-1"></i></span>
                    ...
                    <div class="form-group col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-person-badge-fill me-1"></i></span>
                            <input id="document_number" type="text" name="document_number" value="{{old('document_number')}}" class="form-control">
                        </div>
                        <span class="help-block"></span>
                    </div>
                    ...
                    <div class="form-group col-12 mt-2">
                        <label for="attach">@lang('Attach')</label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-file-earmark-richtext me-1"></i></span>
                            <input id="attach" type="file" name="attach" value="" class="form-control">
                        </div>
                        <span class="help-block"></span>
                    </div>
